        ...
        <div>
            ...
            >
                ...
                <div class="lg:hidden">
                    ...
                    >
                        <svg
                            class="block h-4 w-full fill-current"
                            viewBox="0 0 20 20"
                ...
                >
                    <li>
                        <a
                            class="text-sm text-white hover:text-gray-500"
                            :href="`/`"
                            >Home</a
                        >
                    </li>
                ...
                <div v-else>
                    <a
                        class="
                            hidden
                            lg:inline-block lg:ml-auto lg:mr-3
                            py-2
                            px-6
                            bg-gray-50
                            hover:bg-gray-100
        ...
        <div ref="menu" class="navbar-menu relative z-50 hidden">
            ...
            >
                <div class="flex items-center mb-8">
                    ...
                    <button
                        @click="toggleMenu"
                        class="navbar-close hover:bg-gray-100"
                    >
                        <svg
                            class="
                                h-6
