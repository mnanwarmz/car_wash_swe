            ...
            >
                ...
                >
                    ...
                    <a :href="`/appointments/create`">
                            ...
                            <a :href="`/branches/create`"><button class="flex-auto inline-block py-2 px-6 rounded-l-xl rounded-t-xl bg-green-600 hover:bg-green-700 text-gray-50 font-bold transition duration-200">Become our rider or open up a branch here!</button></a>
                    </div>
            ...
            <div class="flex flex-wrap -mx-4">
                <div class="md:w-1/4 p-4 mb-4 md:mb-0">
                    ...
                    <p class="text-gray-400 leading-relaxed">
                        Forget about paper jams with our increased stability
                        product.
                    </p>
                </div>
                <div class="md:w-1/4 p-4 mb-4 md:mb-0">
                ...
                <div class="md:w-1/4 p-4 mb-4 md:mb-0">
                    ...
                    <p class="text-gray-400 leading-relaxed">
                        The best combination of quality and economy comes with
                        our paper.
                    </p>
                </div>
                <div class="md:w-1/4 p-4 mb-4 md:mb-0">
                    ...
                    <h3 class="text-xl my-2 font-semibold font-heading">
                        Variety
                    </h3>
                    <p class="text-gray-400 leading-relaxed">
                        The offer includes paper in wide range of density and
                        sizes.
                    </p>
                </div>
            </div>
