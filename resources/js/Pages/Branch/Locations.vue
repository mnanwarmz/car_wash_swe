...
<div class="px-16 py-20 text-gray-700 bg-gray-200 h-auto w-screen">
    <h1 class="text-black text-4xl flex flex-wrap justify-center ">Branch's Location</h1>
    <section class="container mx-auto p-6 font-mono">
        <div class="w-full mb-8 overflow-hidden rounded-lg shadow-lg">
            ...
            <table class="w-full">
                ...
                <tr class="text-gray-700" v-for="branch in branches" :key="branch">
                    ...
                    <div class="flex items-center text-sm">
                        ...
                        <div>
                        <p class="font-semibold text-black">{{branch.name}}</p>
                        </div>
                    </div>
                    </td>
