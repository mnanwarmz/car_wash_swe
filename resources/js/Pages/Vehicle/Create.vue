        ...
        <div class="md:grid md:grid-cols-3 md:ml-10">
            ...
            <div
                class="
                    shadow
                    overflow-hidden
                    sm:rounded-md sm:mx-10 sm:mb-16
                    bg-green-300
                "
                id="form"
            >
...
export default {
    ...
    updated() {
        this.price = this.vehicle_types.find(
            (vehicle_type) => vehicle_type.id == this.form.vehicle_type_id
        ).price;
        this.plate_no = this.form.plate_no;
        this.brand = this.form.brand;
        this.model = this.form.model;
        this.vehicle_type_name = this.vehicle_types.find(
            (vehicle_type) => vehicle_type.id == this.form.vehicle_type_id
        ).name;
    },
    methods: {
